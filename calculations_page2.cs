...
namespace Father
{
    public partial class calculations_page2 : Form
    {
        ...
        {
            label1.Text = $"0/{calculations.max_61_amount}";
            label2.Text = $"0/{calculations.max_62_amount}";
            label3.Text = $"0/{calculations.max_63_amount}";
            label4.Text = $"0/{calculations.max_64_amount}";
            label5.Text = $"0/{calculations.max_65_amount}";
            label6.Text = $"0/{calculations.max_66_amount}";
            label7.Text = $"0/{calculations.max_67_amount}";
            label8.Text = $"0/{calculations.max_68_amount}";
            label9.Text = $"0/{calculations.max_69_amount}";
            label10.Text = $"0/{calculations.max_70_amount}";
            label11.Text = $"0/{calculations.max_71_amount}";
            label12.Text = $"0/{calculations.max_72_amount}";
            label13.Text = $"0/{calculations.max_73_amount}";
            label14.Text = $"0/{calculations.max_74_amount}";
            label15.Text = $"0/{calculations.max_75_amount}";
            label16.Text = $"0/{calculations.max_76_amount}";
            label17.Text = $"0/{calculations.max_77_amount}";
            label18.Text = $"0/{calculations.max_78_amount}";
            label19.Text = $"0/{calculations.max_79_amount}";
            label20.Text = $"0/{calculations.max_80_amount}";
            label21.Text = $"0/{calculations.max_81_amount}";
            label22.Text = $"0/{calculations.max_82_amount}";
            label23.Text = $"0/{calculations.max_83_amount}";
            label24.Text = $"0/{calculations.max_84_amount}";
            label25.Text = $"0/{calculations.max_85_amount}";
            label26.Text = $"0/{calculations.max_86_amount}";
            label27.Text = $"0/{calculations.max_87_amount}";
            label28.Text = $"0/{calculations.max_88_amount}";
            label29.Text = $"0/{calculations.max_89_amount}";
            label30.Text = $"0/{calculations.max_90_amount}";
            label31.Text = $"0/{calculations.max_91_amount}";
            label32.Text = $"0/{calculations.max_92_amount}";
            label33.Text = $"0/{calculations.max_93_amount}";
            label34.Text = $"0/{calculations.max_94_amount}";
            label35.Text = $"0/{calculations.max_95_amount}";
            label36.Text = $"0/{calculations.max_96_amount}";
            label37.Text = $"0/{calculations.max_97_amount}";
            label38.Text = $"0/{calculations.max_98_amount}";
            label39.Text = $"0/{calculations.max_99_amount}";
            label40.Text = $"0/{calculations.max_100_amount}";
            label41.Text = $"0/{calculations.max_101_amount}";
            label42.Text = $"0/{calculations.max_102_amount}";
            label43.Text = $"0/{calculations.max_103_amount}";
            label44.Text = $"0/{calculations.max_104_amount}";
            label45.Text = $"0/{calculations.max_105_amount}";
            label46.Text = $"0/{calculations.max_106_amount}";
            label47.Text = $"0/{calculations.max_107_amount}";
            label48.Text = $"0/{calculations.max_108_amount}";
            label49.Text = $"0/{calculations.max_109_amount}";
            label50.Text = $"0/{calculations.max_110_amount}";
            label51.Text = $"0/{calculations.max_111_amount}";
            label52.Text = $"0/{calculations.max_112_amount}";
            label53.Text = $"0/{calculations.max_113_amount}";
            label54.Text = $"0/{calculations.max_114_amount}";
            label55.Text = $"0/{calculations.max_115_amount}";
            label56.Text = $"0/{calculations.max_116_amount}";
            label57.Text = $"0/{calculations.max_117_amount}";
            label58.Text = $"0/{calculations.max_118_amount}";
            label59.Text = $"0/{calculations.max_119_amount}";
            label60.Text = $"0/{calculations.max_120_amount}";
        }
